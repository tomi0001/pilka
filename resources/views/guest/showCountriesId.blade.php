            ...
            <div class="grid grid-cols-2 gap-2">
                ...
                <div class="bg-blue-100 text-blue-800 px-4 py-2 ">
                    <span @class([
                       ...
                       " <a href='" . route('guest.showGroupForm', ['group' => \App\Http\Repositories\ProfileRepository::showNameGroup($idCountry,session()->get('oldGroup'))->group_id]) . "'> Grupa " . \App\Http\Repositories\ProfileRepository::showNameGroup($idCountry,session()->get('oldGroup'))->name . "</a>" !!}
                         </span>
                </div>
