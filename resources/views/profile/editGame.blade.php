<x-app-layout>
    <div class="main-page-game-edit">
        <form action="{{ route('profile.editGameSubmit', $game->id) }}" method="GET">
            @csrf
            @method('PUT')
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <div class="bg-blue-100 text-blue-800 px-4 py-2 ">
                        <input  type="number" name="resultOne" autocomplete="family-name" max="300" min="0" step="1" value="{{ $game->result_one }}"
                    ...
                    <div class="bg-blue-100 text-blue-800 px-4 py-2 ">
                        <input type="number" name="resultTwo" autocomplete="family-name" max="300" min="0" step="1" value="{{ $game->result_two }}"
                    ...
                    <div class="bg-blue-100 text-blue-800 px-4 py-2 ">
                        <input type="time" name="time" id="time" value="{{ substr($game->date, 11, 16) }}" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                    </div>
                </div>
