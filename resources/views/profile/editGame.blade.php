        ...
        <form action="{{ route('profile.editGameSubmit', $game->id) }}" method="POST">
            ...
            <div class="grid grid-cols-2 gap-2">
                ...
                <div class="bg-blue-100 text-blue-800 px-4 py-2 ">
                    <input type="number" name="resultOne" autocomplete="family-name" max="255" min="0"
                        step="1" value="{{ $game->result_one }}"
                ...
                <div class="bg-blue-100 text-blue-800 px-4 py-2 ">
                    <input type="number" name="resultTwo" autocomplete="family-name" max="255" min="0"
                        step="1" value="{{ $game->result_two }}"
                        class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                        value="{{ old('resultTwo') }}" />
                </div>
                @if ($game->status >= 0)
                    ...
                    <div class="bg-blue-100 text-blue-800 px-4 py-2 ">
                        <input type="number" name="result_over_one" autocomplete="family-name" max="255"
                            min="0" step="1" value="{{ $game->result_over_one }}"
                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                            value="{{ old('resultOverOne') }}" />
                    </div>
                    <div class="bg-blue-100 text-blue-800 px-4 py-2 	flex items-center justify-center">
                        Wynik Dogrywki: <br> {{ \App\Models\Countrie::find($game->country_two)->name }}:
                    </div>
                    <div class="bg-blue-100 text-blue-800 px-4 py-2 ">
                        <input type="number" name="result_over_two" autocomplete="family-name" max="255"
                            min="0" step="1" value="{{ $game->result_over_two }}"
                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                            value="{{ old('resultOverTwo') }}" />
                    </div>
                    <div class="bg-blue-100 text-blue-800 px-4 py-2 	flex items-center justify-center">
                        Wynik rzutów karnych: <br> {{ \App\Models\Countrie::find($game->country_one)->name }}:
                    </div>
                    <div class="bg-blue-100 text-blue-800 px-4 py-2 ">
                        <input type="number" name="result_pena_one" autocomplete="family-name" max="255"
                            min="0" step="1" value="{{ $game->result_pena_one }}"
                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                            value="{{ old('resultPenaOne') }}" />
                    </div>
                    <div class="bg-blue-100 text-blue-800 px-4 py-2 	flex items-center justify-center">
                        Wynik rzutów karnych: <br> {{ \App\Models\Countrie::find($game->country_two)->name }}:
                    </div>
                    <div class="bg-blue-100 text-blue-800 px-4 py-2 ">
                        <input type="number" name="result_pena_two" autocomplete="family-name" max="255"
                            min="0" step="1" value="{{ $game->result_pena_two }}"
                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                            value="{{ old('resultPenaTwo') }}" />
                    </div>
                @endif
                ...
                <div class="bg-blue-100 text-blue-800 px-4 py-2 ">
                    <input type="date" name="date" id="date" value="{{ substr($game->date, 0, 10) }}"
                        class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                </div>
                ...
                <div class="bg-blue-100 text-blue-800 px-4 py-2 ">
                    <input type="time" name="time" id="time" value="{{ substr($game->date, 11, 5) }}"
                        class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                </div>
            </div>
