                    ...
                    <section>
                        ...
                        <form action="{{ route('profile.addGameSubmit') }}" method="post" class="mt-6 space-y-6">
                            ...
                            <div>
                                ...
                                <select name="countryOne" id="countryOne"
                                    class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                                    <option value=""></option>
                                    @foreach ($listCountry as $country)
                                        <option value="{{ $country->id }}" @selected(old('countryOne') == $country->id ? true : false)>
                                            {{ $country->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select name="countryTwo" id="countryTwo"
                                    ...
                                    <option value=""></option>
                                    @foreach ($listCountry as $country)
                                        <option value="{{ $country->id }}" @selected(old('countryTwo') == $country->id ? true : false)>
                                            {{ $country->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input id="date" type="date" name="date" autocomplete="family-name"
                                    maxlength="200"
                                    class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                                    value="{{ old('date') }}" />
                                <input id="time" type="time" name="time" autocomplete="family-name"
                                    maxlength="200"
                                    class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                                    value="{{ old('time') }}" />
                            ...
                            <div>
                                ...
                                <input type="number" name="resultOne" autocomplete="family-name" max="255"
                                    min="0" step="1"
                                    class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                                    value="{{ old('resultOne') }}" />
                                <input type="number" name="resultTwo" autocomplete="family-name" max="255"
                                    min="0" step="1"
                                    class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                                    value="{{ old('resultTwo') }}" />
                            ...
                            @if (Auth::user()->status >= 0)
                                <div>
                                    ...
                                    <input type="number" name="result_over_one" autocomplete="family-name"
                                        max="255" min="0" step="1"
                                        class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                                        value="{{ old('result_over_one') }}" />
                                    <input type="number" name="result_over_two" autocomplete="family-name"
                                        max="255" min="0" step="1"
                                        class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                                        value="{{ old('result_over_two') }}" />

                                    <x-input-error :messages="$errors->get('result_over_one')" class="mt-2" />
                                    <x-input-error :messages="$errors->get('result_over_two')" class="mt-2" />
                                </div>
                                <div>
                                    <span class="text-gray-600 font-light text-x2 "> Wynik Rzutów karnych
                                        opcjonalnie</span>
                                    <input type="number" name="result_pena_one" autocomplete="family-name"
                                        max="255" min="0" step="1"
                                        class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                                        value="{{ old('result_pena_one') }}" />
                                    <input type="number" name="result_pena_two" autocomplete="family-name"
                                        max="255" min="0" step="1"
                                        class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                                        value="{{ old('result_pena_two') }}" />
